    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyFeatureFlags", x => new { x.CompanyId, x.FeatureKey });
                    table.ForeignKey(
                        name: "FK_CompanyFeatureFlags_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequireTaskDueDate = table.Column<bool>(type: "bit", nullable: false),
                    AllowMembersInvite = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyFeatureFlags_FeatureKey",
                table: "CompanyFeatureFlags",
                column: "FeatureKey");
