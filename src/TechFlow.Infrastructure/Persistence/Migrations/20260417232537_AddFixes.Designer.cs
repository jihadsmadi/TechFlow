...
namespace TechFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260417232537_AddFixes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechFlow.Domain.Invitations.Invitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "IsUsed", "IsRevoked");

                    b.HasIndex("CompanyId", "Email", "IsUsed", "IsRevoked");
            ...
            modelBuilder.Entity("TechFlow.Domain.Sprints.Sprint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TechFlow.Domain.Sprints.ValueObjects.SprintItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SprintItems", (string)null);
                });
            ...
            modelBuilder.Entity("TechFlow.Domain.Sprints.ValueObjects.SprintItem", b =>
                {
                    b.HasOne("TechFlow.Domain.Sprints.Sprint", null)
                        .WithMany("Items")
